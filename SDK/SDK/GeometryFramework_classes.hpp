...
{
public:
	uint8                                         Pad_578[0x20];                                     // 0x0578(0x0020)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_5B7[0x1];                                      // 0x05B7(0x0001)(Fixing Size After Last Property [ Dumper-8 ])
	...
	class UMaterialInterface*                     WireframeMaterialOverride;                         // 0x05D0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     SecondaryWireframeMaterialOverride;                // 0x05D8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TArray<class UMaterialInterface*>             BaseMaterials;                                     // 0x05E8(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
{
public:
	class UDynamicMesh*                           MeshObject;                                        // 0x0600(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_608[0x59];                                     // 0x0608(0x0059)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_662[0xCE];                                     // 0x0662(0x00CE)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_731[0xEF];                                     // 0x0731(0x00EF)(Fixing Size After Last Property [ Dumper-8 ])
	...
	class UBodySetup*                             MeshBodySetup;                                     // 0x0828(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_830[0x38];                                     // 0x0830(0x0038)(Fixing Size After Last Property [ Dumper-8 ])
	struct FKAggregateGeom                        AggGeom;                                           // 0x0868(0x00A0)(Edit, Protected, NativeAccessSpecifierProtected)
	TArray<class UBodySetup*>                     AsyncBodySetupQueue;                               // 0x0908(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_918[0x8];                                      // 0x0918(0x0008)(Fixing Struct Size After Last Property [ Dumper-8 ])
