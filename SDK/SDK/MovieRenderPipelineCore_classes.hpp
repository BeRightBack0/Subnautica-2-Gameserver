...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieGraphApplyViewportLookNode">();
	}
...
public:
	...
	uint8                                         Pad_AA[0x76];                                      // 0x00AA(0x0076)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	TMap<TSubclassOf<class UObject>, class UMovieGraphBurnInWidget*> BurnInWidgetInstances;          // 0x0148(0x0050)(ExportObject, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	class UMovieGraphCollection*                  Collection;                                        // 0x00B0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_A8[0xE8];                                      // 0x00A8(0x00E8)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_38[0x228];                                     // 0x0038(0x0228)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_F1[0xBF];                                      // 0x00F1(0x00BF)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	class UMovieGraphMergeableModifierContainer*  ModifiersContainer;                                // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	TMap<class UMovieGraphConfig*, class UMovieGraphConfig*> DuplicatedGraphs;                       // 0x00C8(0x0050)(Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UMoviePipelineExecutorShot*>     ActiveShotList;                                    // 0x0118(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	...
	class UMovieGraphRenderPreviewWidget*         PreviewWidget;                                     // 0x0130(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UMovieGraphScriptBase*>          CurrentScriptInstances;                            // 0x0138(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TSet<class UMovieGraphFileOutputNode*>        OutputNodesDataSentTo;                             // 0x0148(0x0050)(Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_198[0x68];                                     // 0x0198(0x0068)(Fixing Size After Last Property [ Dumper-8 ])
	class UMovieGraphEngineTimeStep*              CustomEngineTimeStep;                              // 0x0200(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UEngineCustomTimeStep*                  PrevCustomEngineTimeStep;                          // 0x0208(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_210[0x58];                                     // 0x0210(0x0058)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	TMap<class FName, class UMovieGraphQuickRenderModeSettings*> ModeSettings;                       // 0x0028(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieGraphQuickRenderSettings">();
	}
...
public:
	...
	TArray<class UMovieJobVariableAssignmentContainer*> GraphVariableAssignments;                    // 0x0090(0x0010)(Edit, BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieGraphQuickRenderModeSettings">();
	}
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieGraphRerouteNode">();
	}
...
{
public:
	class UMovieGraphValueContainer*              SelectOptions;                                     // 0x00A8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMovieGraphValueContainer*              SelectedOption;                                    // 0x00B0(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieGraphMetadataAttributeCollection">();
	}
...
public:
	...
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	class UMovieGraphMetadataAttributeCollection* MetadataAttributeCollection;                       // 0x00B0(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieGraphSetMetadataAttributesNode">();
	}
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieGraphStartEndConsoleCommands">();
	}
...
public:
	...
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	class UMovieGraphStartEndConsoleCommands*     ConsoleCommands;                                   // 0x00B0(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieGraphSetStartEndConsoleCommandsNode">();
	}
...
{
public:
	class UMovieGraphVariable*                    GraphVariable;                                     // 0x00A8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                         Pad_5E[0xA];                                       // 0x005E(0x000A)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieRenderGraphEditorSettings">();
	}
...
{
public:
	TArray<TSubclassOf<class UObject>>            ActorTypes;                                        // 0x0030(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<TSubclassOf<class UObject>>            ComponentTypes;                                    // 0x0040(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieGraphConditionGroupQuery_IsSpawnable">();
	}
...
public:
	...
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	TArray<class UMovieGraphConditionGroupQueryBase*> Queries;                                       // 0x0040(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                         Pad_B8[0x258];                                     // 0x00B8(0x0258)(Fixing Size After Last Property [ Dumper-8 ])
	class UMoviePipelineExecutorJob*              CurrentJob;                                        // 0x0310(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_318[0x138];                                    // 0x0318(0x0138)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_141[0x3F];                                     // 0x0141(0x003F)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_88[0xD8];                                      // 0x0088(0x00D8)(Fixing Size After Last Property [ Dumper-8 ])
	...
	class UMoviePipelineShotConfig*               ShotOverrideConfig;                                // 0x0178(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TArray<class UMovieJobVariableAssignmentContainer*> GraphVariableAssignments;                    // 0x01D0(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class UMovieJobVariableAssignmentContainer*> PrimaryGraphVariableAssignments;             // 0x01E0(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
public:
	...
	TArray<class UMovieJobVariableAssignmentContainer*> GraphVariableAssignments;                    // 0x0158(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
