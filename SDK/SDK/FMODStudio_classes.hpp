...
// 0x01D8 (0x0428 - 0x0250)
#pragma pack(push, 0x1)
class alignas(0x08) UFMODAudioComponent : public USceneComponent
{
public:
	...
	uint8                                         Pad_314[0x114];                                    // 0x0314(0x0114)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	class UFMODAudioLinkSettings*                 Settings;                                          // 0x0258(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundBase*                             Sound;                                             // 0x0260(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAudioComponent*                        AudioComponent;                                    // 0x0268(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"FMODCallbackHandler">();
	}
