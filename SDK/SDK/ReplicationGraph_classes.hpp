...
public:
	...
	uint8                                         Pad_B8[0xD8];                                      // 0x00B8(0x00D8)(Fixing Size After Last Property [ Dumper-8 ])
	TSet<class AActor*>                           ActiveNetworkActors;                               // 0x0190(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_1E0[0x368];                                    // 0x01E0(0x0368)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	uint8                                         Pad_50[0x210];                                     // 0x0050(0x0210)(Fixing Struct Size After Last Property [ Dumper-8 ])
