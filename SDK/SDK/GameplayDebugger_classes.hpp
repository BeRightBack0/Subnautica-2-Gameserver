...
{
public:
	class APlayerController*                      OwnerPC;                                           // 0x02B0(0x0008)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                         Pad_590[0x70];                                     // 0x0590(0x0070)(Fixing Struct Size After Last Property [ Dumper-8 ])
